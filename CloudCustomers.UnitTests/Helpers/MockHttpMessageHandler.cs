...
namespace CloudCustomers.UnitTests.Helpers
{
    ...
    {
        internal static Mock<HttpMessageHandler> SetupBasicGetResourceList(List<T> expectedResult)
        {
        ...
        internal static Mock<HttpMessageHandler> SetupBasicGetResourceList(List<User> expectedResopnse, string endpoint)
        {
            var mockResponse = new HttpResponseMessage(System.Net.HttpStatusCode.OK)
            {
                Content = new StringContent(JsonConvert.SerializeObject(expectedResopnse))
            };
